...
namespace FontMaker
{
    public class BaseFontData
    {

        public static string[,] arrGB2312 = new string[,]{
    {""," ","、","。","・","ˉ","ˇ","¨","〃","々","―","～","‖","…","‘","’"},
    {"“","”","〔","〕","〈","〉","《","》","「","」","『","』","〖","〗","【","】"},
    {"±","×","÷","∶","∧","∨","∑","∏","∪","∩","∈","∷","√","⊥","∥","∠"},
    {"⌒","⊙","∫","∮","≡","≌","≈","∽","∝","≠","≮","≯","≤","≥","∞","∵"},
    ...
    {"别","瘪","彬","斌","濒","滨","宾","摈","兵","冰","柄","丙","秉","饼","炳",""},
    {"","病","并","玻","菠","播","拨","钵","波","博","勃","搏","铂","箔","伯","帛"},
    ...
    {"拆","柴","豺","搀","掺","蝉","馋","谗","缠","铲","产","阐","颤","昌","猖",""},
    {"","场","尝","常","长","偿","肠","厂","敞","畅","唱","倡","超","抄","钞","朝"},
    ...
    {"仇","绸","瞅","丑","臭","初","出","橱","厨","躇","锄","雏","滁","除","楚",""},
    {"","础","储","矗","搐","触","处","揣","川","穿","椽","传","船","喘","串","疮"},
    ...
    {"答","瘩","打","大","呆","歹","傣","戴","带","殆","代","贷","袋","待","逮",""},
    {"","怠","耽","担","丹","单","郸","掸","胆","旦","氮","但","惮","淡","诞","弹"},
    ...
    {"叼","雕","凋","刁","掉","吊","钓","调","跌","爹","碟","蝶","迭","谍","叠",""},
    {"","丁","盯","叮","钉","顶","鼎","锭","定","订","丢","东","冬","董","懂","动"},
    ...
    {"娥","恶","厄","扼","遏","鄂","饿","恩","而","儿","耳","尔","饵","洱","二",""},
    {"","贰","发","罚","筏","伐","乏","阀","法","珐","藩","帆","番","翻","樊","矾"},
    ...
    {"佛","否","夫","敷","肤","孵","扶","拂","辐","幅","氟","符","伏","俘","服",""},
    {"","浮","涪","福","袱","弗","甫","抚","辅","俯","釜","斧","脯","腑","府","腐"},
    ...
    {"葛","格","蛤","阁","隔","铬","个","各","给","根","跟","耕","更","庚","羹",""},
    {"","埂","耿","梗","工","攻","功","恭","龚","供","躬","公","宫","弓","巩","汞"},
    ...
    {"桂","柜","跪","贵","刽","辊","滚","棍","锅","郭","国","果","裹","过","哈",""},
    {"","骸","孩","海","氦","亥","害","骇","酣","憨","邯","韩","含","涵","寒","函"},
    ...
    {"吼","厚","候","后","呼","乎","忽","瑚","壶","葫","胡","蝴","狐","糊","湖",""},
    {"","弧","虎","唬","护","互","沪","户","花","哗","华","猾","滑","画","划","化"},
    ...
    {"火","获","或","惑","霍","货","祸","击","圾","基","机","畸","稽","积","箕",""},
    {"","肌","饥","迹","激","讥","鸡","姬","绩","缉","吉","极","棘","辑","籍","集"},
    ...
    {"拣","捡","简","俭","剪","减","荐","槛","鉴","践","贱","见","键","箭","件",""},
    {"","健","舰","剑","饯","渐","溅","涧","建","僵","姜","将","浆","江","疆","蒋"},
    ...
    {"金","今","津","襟","紧","锦","仅","谨","进","靳","晋","禁","近","烬","浸",""},
    {"","尽","劲","荆","兢","茎","睛","晶","鲸","京","惊","精","粳","经","井","警"},
    ...
    {"攫","抉","掘","倔","爵","觉","决","诀","绝","均","菌","钧","军","君","峻",""},
    {"","俊","竣","浚","郡","骏","喀","咖","卡","咯","开","揩","楷","凯","慨","刊"},
    ...
    {"筐","狂","框","矿","眶","旷","况","亏","盔","岿","窥","葵","奎","魁","傀",""},
    {"","馈","愧","溃","坤","昆","捆","困","括","扩","廓","阔","垃","拉","喇","蜡"},
    ...
    {"鲤","礼","莉","荔","吏","栗","丽","厉","励","砾","历","利","傈","例","俐",""},
    {"","痢","立","粒","沥","隶","力","璃","哩","俩","联","莲","连","镰","廉","怜"},
    ...
    {"吗","埋","买","麦","卖","迈","脉","瞒","馒","蛮","满","蔓","曼","慢","漫",""},
    {"","谩","芒","茫","盲","氓","忙","莽","猫","茅","锚","毛","矛","铆","卯","茂"},
    ...
    {"灭","民","抿","皿","敏","悯","闽","明","螟","鸣","铭","名","命","谬","摸",""},
    {"","摹","蘑","模","膜","磨","摩","魔","抹","末","莫","墨","默","沫","漠","寞"},
    ...
    {"酿","鸟","尿","捏","聂","孽","啮","镊","镍","涅","您","柠","狞","凝","宁",""},
    {"","拧","泞","牛","扭","钮","纽","脓","浓","农","弄","奴","努","怒","女","暖"},
    ...
    {"硼","篷","膨","朋","鹏","捧","碰","坯","砒","霹","批","披","劈","琵","毗",""},
    {"","啤","脾","疲","皮","匹","痞","僻","屁","譬","篇","偏","片","骗","飘","漂"},
    ...
    {"起","岂","乞","企","启","契","砌","器","气","迄","弃","汽","泣","讫","掐",""},
    {"","恰","洽","牵","扦","钎","铅","千","迁","签","仟","谦","乾","黔","钱","钳"},
    ...
    {"丘","邱","球","求","囚","酋","泅","趋","区","蛆","曲","躯","屈","驱","渠",""},
    {"","取","娶","龋","趣","去","圈","颧","权","醛","泉","全","痊","拳","犬","券"},
    ...
    {"瑞","锐","闰","润","若","弱","撒","洒","萨","腮","鳃","塞","赛","三","叁",""},
    {"","伞","散","桑","嗓","丧","搔","骚","扫","嫂","瑟","色","涩","森","僧","莎"},
    ...
    {"绅","神","沈","审","婶","甚","肾","慎","渗","声","生","甥","牲","升","绳",""},
    {"","省","盛","剩","胜","圣","师","失","狮","施","湿","诗","尸","虱","十","石"},
    ...
    {"署","蜀","黍","鼠","属","术","述","树","束","戍","竖","墅","庶","数","漱",""},
    {"","恕","刷","耍","摔","衰","甩","帅","栓","拴","霜","双","爽","谁","水","睡"},
    ...
    {"损","笋","蓑","梭","唆","缩","琐","索","锁","所","塌","他","它","她","塔",""},
    {"","獭","挞","蹋","踏","胎","苔","抬","台","泰","酞","太","态","汰","坍","摊"},
    ...
    {"甜","恬","舔","腆","挑","条","迢","眺","跳","贴","铁","帖","厅","听","烃",""},
    {"","汀","廷","停","亭","庭","挺","艇","通","桐","酮","瞳","同","铜","彤","童"},
    ...
    {"宛","婉","万","腕","汪","王","亡","枉","网","往","旺","望","忘","妄","威",""},
    {"","巍","微","危","韦","违","桅","围","唯","惟","为","潍","维","苇","萎","委"},
    ...
    {"勿","务","悟","误","昔","熙","析","西","硒","矽","晰","嘻","吸","锡","牺",""},
    {"","稀","息","希","悉","膝","夕","惜","熄","烯","溪","汐","犀","檄","袭","席"},
    ...
    {"橡","像","向","象","萧","硝","霄","削","哮","嚣","销","消","宵","淆","晓",""},
    {"","小","孝","校","肖","啸","笑","效","楔","些","歇","蝎","鞋","协","挟","携"},
    ...
    {"叙","旭","序","畜","恤","絮","婿","绪","续","轩","喧","宣","悬","旋","玄",""},
    {"","选","癣","眩","绚","靴","薛","学","穴","雪","血","勋","熏","循","旬","询"},
    ...
    {"佯","疡","羊","洋","阳","氧","仰","痒","养","样","漾","邀","腰","妖","瑶",""},
    {"","摇","尧","遥","窑","谣","姚","咬","舀","药","要","耀","椰","噎","耶","爷"},
    ...
    {"茵","荫","因","殷","音","阴","姻","吟","银","淫","寅","饮","尹","引","隐",""},
    {"","印","英","樱","婴","鹰","应","缨","莹","萤","营","荧","蝇","迎","赢","盈"},
    ...
    {"羽","玉","域","芋","郁","吁","遇","喻","峪","御","愈","欲","狱","育","誉",""},
    {"","浴","寓","裕","预","豫","驭","鸳","渊","冤","元","垣","袁","原","援","辕"},
    ...
    {"责","择","则","泽","贼","怎","增","憎","曾","赠","扎","喳","渣","札","轧",""},
    {"","铡","闸","眨","栅","榨","咋","乍","炸","诈","摘","斋","宅","窄","债","寨"},
    ...
    {"震","振","镇","阵","蒸","挣","睁","征","狰","争","怔","整","拯","正","政",""},
    {"","帧","症","郑","证","芝","枝","支","吱","蜘","知","肢","脂","汁","之","织"},
    ...
    {"逐","竹","烛","煮","拄","瞩","嘱","主","著","柱","助","蛀","贮","铸","筑",""},
    {"","住","注","祝","驻","抓","爪","拽","专","砖","转","撰","赚","篆","桩","庄"},
    ...
    {"黟","黢","黩","黧","黥","黪","黯","鼢","鼬","鼯","鼹","鼷","鼽","鼾","齄",""}
        ...
        public static string[,] arrASCII = new string[,]{
